        ...
        <div class="col-lg-8">
          <div class="card shadow">
            ...
            <div class="card-body">
              <div class="row mb-3">
                <div class="col-md-6">
                  <p><strong>Nome do Produto:</strong> <?= htmlspecialchars($produto['nome'], ENT_QUOTES, 'UTF-8') ?></p>
                  <p><strong>Código:</strong> <?= htmlspecialchars($produto['codigo'], ENT_QUOTES, 'UTF-8') ?></p>
                  <p><strong>Categoria:</strong> <?= htmlspecialchars($produto['categoria'], ENT_QUOTES, 'UTF-8') ?></p>
                </div>
                <div class="col-md-6">
                  <p><strong>Preço:</strong> R$ <?= number_format((float)$produto['preco'], 2, ',', '.') ?></p>
                  <p><strong>Quantidade:</strong> <?= htmlspecialchars($produto['quantidade'], ENT_QUOTES, 'UTF-8') ?></p>
                  <p><strong>Fornecedor:</strong> <?= htmlspecialchars($produto['fornecedor'], ENT_QUOTES, 'UTF-8') ?></p>
                </div>
              </div>
              <?php if (!empty($produto['validade'])): ?>
              <hr>
              <p><strong>Data de Validade:</strong> <?= htmlspecialchars($produto['validade'], ENT_QUOTES, 'UTF-8') ?></p>
              <?php endif; ?>
            </div>
          </div>
        </div>
